...
const Product = ({post}) => {
  ...
  return (
    ...
    duration-300 ease-in hover:shadow-[0px_30px_90px_rgba(0,255,1,0.71)] gap-3 p-4 mt-10 ml-5 rounded-xl group h-[380px]">
      <div>
        ...
        <div>
...

          {
            ...
            (<button
              ...
              p-1 px-3 uppercase hover:bg-lime-900 hover:text-white transition duration-300 ease-in group-hover:text-white group-hover:bg-lime-900"
