...
function Visuals() {
   ...
   const handlePlayPause = (play) => {
      if(!myState.play){
         ...
         document.getElementById('change-btn').style.backgroundColor = 'black';
         document.getElementById('play-btn').disabled = true;
         document.getElementById('play-btn').style.backgroundColor = 'black';
      }
      else{
         return;
      }
   ...
   useEffect(() => {
      if(!myState.play){
         ...
         document.getElementById('play-btn').style.backgroundColor = 'rgb(10, 199, 0)';
         document.getElementById('change-btn').disabled = false;
         document.getElementById('change-btn').style.backgroundColor = 'rgb(10, 199, 0)';
      }
   },[myState.play]);
