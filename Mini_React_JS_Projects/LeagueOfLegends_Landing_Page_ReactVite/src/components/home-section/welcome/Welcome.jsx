        ...
        >
            <div className="welcome__info relative">
                <div className="welcome__info__content">
                    ...
                    <div className="btns m-t-4" style={{display: 'flex', justifyContent: 'flex-start'}}>
                        <Button className="btn-main" style={{padding: '1rem'}}>PLAY NOW</Button>
                        <Button className="btn-second" style={{padding: '1rem'}}>GET STARTED</Button>
                    </div>
                </div>
            </div>
